...
//MY code here
SocialCalc.TableEditor.prototype.EditorChangecolor = function(text) {return SocialCalc.EditorChangecolor(this, text);};
SocialCalc.TableEditor.prototype.EditorChangefont = function(text) {return SocialCalc.EditorChangefont(this, text);};
SocialCalc.TableEditor.prototype.EditorCut = function(text) {return SocialCalc.EditorCut(this, text);};
...
SocialCalc.EditorSaveEdit = function(editor, text) {
  ...
  SocialCalc.EditorChangecolor = function(editor, text) {
  ...
  if (SocialCalc.Callbacks && SocialCalc.Callbacks.IsCellEditable) {
   ...
   cmdline = "set "+wval.ecoord+" "+"color"+" "+value;
   editor.EditorScheduleSheetCommands(cmdline, true, false);

   return;

   }
	SocialCalc.EditorChangefont = function(editor, text) {
  ...
  if (SocialCalc.Callbacks && SocialCalc.Callbacks.IsCellEditable) {
   ...
   return;
	...
	SocialCalc.EditorCut = function(editor, text) {
...
if(value=="a"){
   ...
   cmdline = "cut "+wval.ecoord+" all";
}
else if(value=="b"){cmdline = "copy "+wval.ecoord+" all";
alert("Copied");}
else if(value=="c"){cmdline = "paste "+wval.ecoord+" all";}
else if(value=="d"){cmdline = "erase "+wval.ecoord+" formulas";}
...
SocialCalc.InputBoxDisplayCellContents = function(inputbox, coord) {
   ...
   if (!inputbox) return;
   if (!coord) return;// coord = inputbox.editor.ecell.coord;
